...
_libs['pdfium'] = _get_library(
    ...
    libpaths = (
        './{prefix}{name}.{suffix}',
        os.path.join(os.path.dirname(os.path.abspath(__file__)), 'libpdfium.so'),
        'libpdfium.so',
    ),
    search_sys = True,
)
...
# /usr/include/aarch64-linux-gnu/bits/types.h: 38
__uint8_t = c_ubyte

# /usr/include/aarch64-linux-gnu/bits/types.h: 40
__uint16_t = c_ushort

# /usr/include/aarch64-linux-gnu/bits/types.h: 42
__uint32_t = c_uint

# /usr/include/aarch64-linux-gnu/bits/types.h: 160
__time_t = c_long

# /usr/include/aarch64-linux-gnu/bits/stdint-uintn.h: 23
uint8_t = __uint8_t

# /usr/include/aarch64-linux-gnu/bits/stdint-uintn.h: 24
uint16_t = __uint16_t

# /usr/include/aarch64-linux-gnu/bits/stdint-uintn.h: 25
uint32_t = __uint32_t
...
# /usr/include/aarch64-linux-gnu/bits/types/time_t.h: 9
time_t = __time_t

# /usr/include/aarch64-linux-gnu/bits/types/struct_tm.h: 6
