...
## 🌟 Tính năng chính
- Hỗ trợ đa dạng các định dạng truyện tranh & tài liệu nén: **PDF, CBZ, CBR, CB7, ZIP, RAR, 7Z, CBT, TAR**.
...
- **Render PDF độ nét cao:** Tích hợp engine rasterizer chuyên dụng kết xuất từng trang PDF trực tiếp vào RAM, giữ nguyên 100% font chữ, layout và hình ảnh tài liệu.
...
- Tự động lưu vị trí đọc (trang hiện tại) cho từng truyện/tài liệu.
...
5. Chép truyện và tài liệu định dạng `.pdf`, `.cbz`, `.cbr`, `.cb7`, `.zip`, `.rar` vào thư mục `Books` trên thẻ nhớ.
